...
@inject('toggleStore')
@observer
class NewDisciplinary extends Component {
    constructor(){
        super()
                                ...
                                <Col span={24}>
                                    ...
                                    <Col span={12} >
                                        <Form.Item {...formItemLayout} label={'奖惩原因'}>
                                            {getFieldDecorator(`reasion`)(  <TextArea rows={4} />)}
                                        </Form.Item>
...
export default Form.create({ name: 'NewDisciplinary' })(NewDisciplinary);;